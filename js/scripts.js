...
jQuery(window).on('load', function() {
	if (jQuery("body").hasClass("home")) {
	  ...
	  setTimeout(function() {
	    jQuery('#intro-logo').removeClass('hidden');
	  }, 800);
	  setTimeout(function() {
	    jQuery('#intro-logo').addClass('moved');
	    jQuery('#intro-overlay').fadeOut(1500);
	    jQuery('body').removeClass('no-scroll');
	    jQuery('header.header').removeClass('moved');
	    jQuery('#hero-arrow').addClass('animated bounce-2x');
	  }, 3000);
	}
});
...
jQuery(document).ready(function($) {
  ...
  */
  ...
  if ($("body").hasClass("careers")) {
	...
	// $('.job-card a').featherlight({
	// 	targetAttr: 'href',
	// 	afterOpen: function(event){
	// 		var theHash = event.target.closest("a");
	// 		window.location.hash = theHash.getAttribute('href');
	// 	}.bind( this ),
